...
function SortableOverlay(props: SortableOverlayProps) {
  ...
  // Mount detection for the portal: document.body only exists on the client, so
  // the first render has to bail out and the second one puts the overlay in
  // place. Runs once, so the cascading-render warning does not apply.
